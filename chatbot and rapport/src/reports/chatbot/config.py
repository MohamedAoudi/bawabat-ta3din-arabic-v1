...
DB_HOST: str = _env("DB_HOST", "PG_WAREHOUSE_HOST", "localhost")
DB_PORT: int = int(_env("DB_PORT", "PG_WAREHOUSE_PORT", "5432"))
DB_NAME: str = _env("DB_NAME", "PG_WAREHOUSE_DB", "arab_minerals_dw")
DB_USER: str = _env("DB_USER", "PG_WAREHOUSE_USER", "AIDSMO")
DB_PASSWORD: str = _env("DB_PASSWORD", "PG_WAREHOUSE_PASSWORD", "")
DB_SCHEMA: str = os.getenv("DB_SCHEMA", "minerals")
