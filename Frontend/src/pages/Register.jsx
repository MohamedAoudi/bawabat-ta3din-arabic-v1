      ...
      <div className={`w-full max-w-2xl p-8 rounded-2xl shadow-xl ${isDarkMode ? "bg-gray-800" : "bg-white"}`}>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            ...
            className={`w-full py-3 px-6 rounded-lg font-semibold border transition-all flex items-center justify-center gap-3
              ${isDarkMode 
          ...
          >
            ...
            <span>
              {googleLoading 
                ...
                : (language === "ar" ? "إنشاء حساب عبر Google" : language === "fr" ? "S'inscrire avec Google" : "Sign up with Google")
              }
            </span>
          </button>
        </form>
