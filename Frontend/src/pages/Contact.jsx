    ...
    >
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-3 text-sm sm:text-base text-slate-200 leading-relaxed max-w-2xl">
            {t.heroText}
          </p>
        </div>
      </header>

      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-14 pb-16">
