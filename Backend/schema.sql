...
CREATE INDEX idx_arab_production_country ON arab_production(country_id);
CREATE INDEX idx_arab_production_mineral ON arab_production(mineral_production_id);

CREATE INDEX idx_world_production_mineral ON world_production(mineral_production_id);

CREATE INDEX idx_trade_world_year ON trade_world(year);
CREATE INDEX idx_trade_world_country ON trade_world(reporter_country_id);
CREATE INDEX idx_trade_world_partner ON trade_world(partner_id);
